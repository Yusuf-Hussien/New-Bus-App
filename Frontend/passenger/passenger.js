 // Configuration
      ...
      function showAccessDenied() {
        dom.mainContent.innerHTML = `
                <div class="access-denied">
                    ...
                    <p>هذه الصفحة مخصصة للمسافرين فقط. يرجى تسجيل الدخول بحساب مسافر.</p>
      ...
      function renderWelcomeMessage() {
        return `
                <div class="welcome-message">
                    <h1>مرحباً ${state.currentUser.name || "عزيزي المسافر"}</h1>
      ...
      function renderStatsCards() {
        return `
                <div class="stats-cards">
                    ...
                    ${renderStatCard("fas fa-route", "route", "4", "مسار نشط")}
                    ${renderStatCard(
                      "far fa-clock",
                      "time",
                      "2-10",
      ...
      function renderBusesSection() {
        return `
                <h2 class="section-title">
                    <i class="fas fa-bus"></i> الحافلات النشطة الآن
                </h2>
      ...
      function renderBusCard(bus) {
        ...
        const capacityPercent = Math.round((bus.current / bus.capacity) * 100);
