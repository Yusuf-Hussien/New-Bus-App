...
namespace NewBusAPI.Controllers
{
   ...
   : ControllerBase
        ...
        public StudentsController(IStudentBLL StudentBLL)
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<ApiResponseSucess<DTOStudentRead>>> GetStudentByIdAsync([FromRoute] int id)
        {
        var Student = await _StudentBLL.GetStudentByIdAsync(id);
            return Ok(new ApiResponseSucess<DTOStudentRead>(Student, "Student Data"));
        }
        
        [Authorize(Roles = "Admin")]
        [HttpGet("getbyFirstName/{FirstName}")]
        public async Task<ActionResult<ApiResponseSucess<IEnumerable<DTOStudentRead>>>> GetStudentByFirstName([FromRoute] string FirstName)
    {
        var Students = await _StudentBLL.GetStudentByFirstName(FirstName);
            return Ok(new ApiResponseSucess<IEnumerable<DTOStudentRead>>(Students, "Students Data By FirstName"));
    }
        ...
        public async Task<ActionResult<ApiResponseSucess<IEnumerable<DTOStudentRead>>>> GetAdminByLastName([FromRoute] string LastName)
    {
            var Students = await _StudentBLL.GetStudentByLastName(LastName);
            return Ok(new ApiResponseSucess<IEnumerable<DTOStudentRead>>(Students, "Students Data By LastName"));
    }
        [Authorize(Roles = "Admin")]
        [HttpGet("getbyPhone/{Phone}")]

        public async Task<ActionResult<ApiResponseSucess<DTOStudentRead>>> GetStudentByPhone([FromRoute] string Phone)
        {
            var Student = await _StudentBLL.GetStudentByPhone(Phone);
            return Ok(new ApiResponseSucess<DTOStudentRead>(Student, "Student Data By Phone"));
        }
        
        [Authorize(Roles = "Admin")]
        [HttpGet("GetByUsername/{username}")]
        public async Task<ActionResult<ApiResponseSucess<DTOStudentRead>>> GetStudentByUsername([FromRoute] string username)
    {
            var Student = await _StudentBLL.GetStudentByUsernameAsync(username);
            return Ok(new ApiResponseSucess<DTOStudentRead>(Student, "Student Data By Username"));
    }
       
        [Authorize(Roles = "Admin")]
        [HttpGet("ByFaculty/{FacultyID}")]
        public async Task<ActionResult<ApiResponseSucess<IEnumerable<DTOStudentRead>>>> GetAllStudents([FromRoute]int FacultyID)
        {
            var Students = await _StudentBLL.GetStudentsinFacultyID(FacultyID);
            return Ok(new ApiResponseSucess<IEnumerable<DTOStudentRead>>(Students, "Students Data By FacultyID"));
        }
        [Authorize(Roles = "Admin")]
        [HttpGet]
        public async Task<ActionResult<ApiResponseSucess<IEnumerable<DTOStudentRead>>>> GetAllStudents()
       {
            var Students = await _StudentBLL.GetAllStudentsAsync();
            return Ok(new ApiResponseSucess<IEnumerable<DTOStudentRead>>(Students, "Students Data"));
        }

        [AllowAnonymous]
        [HttpPost("SignUp")]
        public async Task<ActionResult<ApiResponseSucess<string>>> AddStudent(DTOStudentCreate dTO)
        {
        ...
        public async Task<ActionResult<ApiResponseSucess<string>>> UpdateStudent(DTOStudentUpdate dTO)
    {
            ...
            return Ok(new ApiResponseSucess<string>("", "Student Updated Successfuly"));
    }
       
        [Authorize(Roles = "Admin")]
        [HttpDelete("{id}")]
        public async Task<ActionResult<ApiResponseSucess<string>>> DeleteStudent([FromRoute] int id)
    {
            await _StudentBLL.DeleteStudentAsync(id);
            return Ok(new ApiResponseSucess<string>("", "Student Deleted Successfuly"));
        }
        ...
        public async Task<ActionResult<ApiResponseSucess<string>>> UpdatePassword(DTOUpdatePassword dtoUpdatePassword)
            ...
            return Ok(new ApiResponseSucess<string>("", "Student Password Updated Successfuly"));
        }
